 ...
 */
export function Hero({ nomeLoja, whatsapp }: { nomeLoja: string; whatsapp: string }) {
      ...
      <div className="mx-auto grid max-w-6xl items-center gap-10 px-4 pb-14 pt-10 sm:pb-20 sm:pt-16 lg:grid-cols-[1.05fr_0.95fr] lg:gap-14">
        <Revelar>
          <div className="flex flex-col items-start">
            <span className="mb-5 inline-flex items-center gap-2 rounded-full border border-ambar-500/30 bg-ambar-500/10 px-3 py-1.5 text-[11px] font-semibold uppercase tracking-[0.18em] text-ambar-400">
            ...
            <p className="mt-5 max-w-lg text-[15px] leading-relaxed text-creme-muted sm:text-lg">
              ...
              pronto para o nosso balcão. Sem cadastro, sem app, sem complicação.
            </p>
          ...
          <div className="relative mx-auto w-full max-w-md">
            <div className="relative overflow-hidden rounded-[28px] border border-carvao-700 shadow-lift">
              <div className="aspect-[4/5]">
                <ArteCorte categoria="bovino" semente={7} />
              </div>
              <div
                aria-hidden="true"
              ...
              <div className="absolute inset-x-5 bottom-5">
                ...
                <p className="text-[13px] text-creme-muted">
                  21 dias de maturação a vácuo
                </p>
              </div>
            </div>

            {/* Etiqueta flutuante: dá a profundidade em camadas sem custo de render */}
            <div className="absolute -left-3 top-8 rotate-[-4deg] rounded-2xl border border-ambar-500/30 bg-carvao-900/95 px-4 py-3 shadow-lift backdrop-blur-sm sm:-left-6">
              ...
              <p className="font-display text-2xl font-semibold text-creme">
                R$ 74,90
                <span className="ml-1 text-[12px] font-normal text-creme-muted">/kg</span>
              </p>
            </div>
          </div>
        </Revelar>
